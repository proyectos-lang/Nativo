...
import {
  ...
  reservasInventarioActivas, movimientosInventario, listasMaestras,
} from "@/lib/consultas";
...
import type { Producto, InventarioUbicacion, InventarioExistencia, InventarioReserva, InventarioMovimiento } from "@/lib/tipos";
...
export default async function PaginaInventario() {
  ...
  const [productos, ubicaciones, existencias, reservas, movimientos, maestros] = await Promise.all([
    productosCatalogo(),
