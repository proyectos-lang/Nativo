...
create table nativo.usuarios (
  ...
  permisos jsonb not null default '{"dashboard": true, "ventas": true, "pagos": true, "entregas": true, "seguimiento": true, "prospectos": true, "clientes": true, "proveedores": false, "configuracion": false, "financiero": false}'::jsonb,
...
create table nativo.movimientos_bancarios (
  ...
  origen text not null default 'manual' check (origen in ('manual', 'pago_venta', 'pago_gasto', 'transferencia', 'pago_ingreso')),
